Feature: REST-assured testing for delete customer info. API
...
Scenario: Delete customer addresses
		Given set the following in request header 
		|Authorization|getSystemProperty|AccessToken|
		When a user send a "DELETE" request to "http://uat.vlvdev.com/rest/V1/mobilewebservice/customers/1541/deleteaddresses/en/"
